...
This folder contains enterprise-level design and engineering documentation for Examen.
...
- [Software Configuration Management](SOFTWARE_CONFIGURATION_MANAGEMENT.md)
- [Software Quality](SOFTWARE_QUALITY.md)
- [Software Maintenance](SOFTWARE_MAINTENANCE.md)

## Data, API, and Platform
